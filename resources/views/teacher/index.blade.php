...
<body>
	<div class="container mt-5">
        <div class="btn-group">
            <a href="#" class="btn btn-info rounded-0" data-toggle="modal" data-target="#teacher_add_modal">Add new teacher</a>
    ...
    {{--    add teacher modal --}}
    <div class="modal fade" id="teacher_add_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <p class="mb-0 text-white font-weight-bold">Add teacher</p>
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <form id="teacher_add_form" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="teacher_add_message"></div>
                        <div class="form-row">
                            <div class="col-sm-6">
    ...
    {{--tacher view modal--}}
    <div class="modal fade" id="teacher_show_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body" id="single_teacher_data">
    ...
    {{--    teacher edit modal--}}
    <div class="modal fade" id="teacher_edit_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" id="edit_single_teacher">
                <div class="modal-header bg-info">
                    <p class="mb-0 text-white font-weight-bold">Edit teacher</p>
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <form id="teacher_edit_form" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="teacher_edit_message"></div>
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">Your name:</label>
